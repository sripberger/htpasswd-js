 ...
 * not supported, because the bcryptjs library already provides a password-
 * checking function, so creating it ourselves is not necessary.
 * @memberof checkUtils
 * @param {String} hashType - 'md5', 'sha1', or 'crypt'
 ...
 * provides a password-checking function, so creating it ourselves is not
 * necessary.
 * @memberof checkUtils
 * @param {String} hashType - 'md5', 'sha1', or 'crypt'
...
exports.checkPassword = function(password, hash) {
	let checkFunction = exports.getCheckFunction(hash);
